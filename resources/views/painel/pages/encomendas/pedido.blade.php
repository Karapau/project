                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr class="table-light">
                                                                ...
                                                                <td><button type="button" class="btn {{$userProduct->status == 0 ? 'btn-dark' : 'btn-success'}} btn-sm @if($userProduct->status == 1) btn_liberar_pedido @endif"  data-route="{{route('admin.status.produto')}}" data-id="{{$userProduct->id}}">{{$userProduct->status == 1 ? 'A LIBERAR' : 'LIBERAR'}}</button></td>
